...
private ["_positions", "_box", "_missionPos", "_randomBox", "_randomCase"];

_setupVars =
{
	_missionType = "Occupation";
	_locationsArray = [ForestMissionMarkers, OccupationMissionMarkers] select (ForestMissionMarkers isEqualTo []);
};
