...
diag_log format ["Apoc's Airdrop Assistance - Player: %1, Drop Type: %2, Selection #: %3",name _player,_type,_selectionNumber];
...
//diag_log format ["Apoc's Airdrop Assistance - Helicopter Spawned at %1", _spos];
...
_object = switch (_type) do
{
	case "vehicle":
	{
		...
		diag_log format ["Apoc's Airdrop Assistance - %1 Spawned at %2", _selectionClass, position _object];
	...
	case "picnic":
	{
		_objectSpawnPos = [(_spos select 0), (_spos select 1), (_spos select 2) - 5];
		_object = createVehicle ["B_supplyCrate_F", _objectSpawnPos, [], 0, "None"];
		diag_log format ["Apoc's Airdrop Assistance - Picnic Spawned at %1", position _object];
...
//diag_log format ["Apoc's Airdrop Assistance - Object at %1, Detaching", position _object]; //A little log love to confirm the location of this new creature
